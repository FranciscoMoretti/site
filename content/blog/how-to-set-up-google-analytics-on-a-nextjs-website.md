...
1. In [**Admin**](https://support.google.com/analytics/answer/6132368), in the _Account_ column, click **Create Account**.
...
1. In the _Property_ column, check that you have your new Google Analytics 4 property selected, then click **Data Streams**, then **Web**. Click the data stream. Your “G-” ID appears at the upper right.
